 ...
 * до появления подписок, иначе остался бы без Figma навсегда.
 */
 ...
 * роли ничего не подключать», а не «взять как у всех».
 */
export const mcpNamesFor = (role: Role): string[] => role.mcp ?? BY_ROLE[role.id] ?? [];
