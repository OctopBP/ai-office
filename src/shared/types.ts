 ...
 */
<<<<<<< HEAD
export type OfficeOp = 'create' | 'switch' | 'rename' | 'remove' | 'open' | 'icon' | 'reorder';
=======
export type OfficeOp = 'create' | 'switch' | 'rename' | 'remove' | 'open' | 'icon' | 'archive';
>>>>>>> main
...
=======
  ...
  archived: boolean;
  /**
   * Когда офис завели. Единственное, по чему список офисов упорядочен —
   * см. `compareOffices`. Уезжает в веб именно ради порядка: без него рейл
   * сортировал бы по имени или по времени открытия, а и то и другое меняется
