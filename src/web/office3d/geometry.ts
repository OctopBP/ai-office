 ...
 *  Пониже подоконник и повыше перемычка (T-72) — окно занимает ~60% высоты
 *  стены вместо трети: на прежних пропорциях модель читалась узкой прорезью. */
export const WINDOW_SILL = 0.6;
export const WINDOW_HEAD = 2.15;
