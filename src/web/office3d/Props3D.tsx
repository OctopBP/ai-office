...
/** Шаг поворота колесом, градусы. Прямой угол: других поворотов в раскладке
 *  не бывает — занятые клетки считаются прямоугольником, и сервер всё равно
 *  прижмёт правку к ближайшему кратному (`normalizeRot`). Мелкий шаг только
 *  создавал бы впечатление, что предмет можно поставить наискось. */
const ROT_STEP = 90;
