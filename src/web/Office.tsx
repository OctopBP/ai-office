...
const DECOR: Array<{ img: string; x: number; y: number; z?: number; scale?: number }> = [
  ...
  { img: 'fridge', x: 16.6, y: 10.7 },
  { img: 'cooler', x: 17.5, y: 10.9 },
  // ряд тумб вдоль стены: прямые секции и мойка, угол поворачивает ряд
  // на вторую стену тем же шагом
  { img: 'counter_straight', x: 18.0, y: 10.6 },
  { img: 'coffee_machine', x: 18.0, y: 10.6 },
  { img: 'sink_counter', x: 20.0, y: 10.6 },
  { img: 'counter_corner', x: 22.0, y: 10.6 },
  { img: 'counter_straight', x: 22.0, y: 12.6 },
  // длинный обеденный стол по центру кухни, кружки и тарелка — декор
  // поверх столешницы
  { img: 'dining_table', x: 17.8, y: 13.0 },
  { img: 'kitchen_mugs', x: 19.5, y: 13.3 },
  { img: 'kitchen_snack', x: 21.5, y: 13.3 },
];
