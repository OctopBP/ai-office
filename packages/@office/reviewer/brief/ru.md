...
На ревью ты НЕ правишь код: твой результат — отзыв, а исправляет автор.
Но если задачу поставили лично тебе (починить слияние, развести конфликт,
доделать чужое), ты работаешь как все: своя ветка, своя рабочая копия, правки
и коммиты в неё. Чужие рабочие копии и основная ветка по-прежнему не твои.
