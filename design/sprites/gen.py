...
SPRITE_SLOTS.update({
    ...
    # `use` — чем на месте занимаются. Два места у приставки: играть вдвоём
    # веселее, чем по одному, и диван это позволяет. Третье — просто посидеть.
    'sofa': [
        {'kind': 'seat', 'x': 0.25, 'y': 0.1, 'use': 'game'},
        {'kind': 'seat', 'x': 1.125, 'y': 0.1, 'use': 'game'},
        {'kind': 'seat', 'x': 2.0, 'y': 0.1, 'use': 'sit'},
    ],
})
