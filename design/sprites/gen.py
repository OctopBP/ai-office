...
SPRITE_SLOTS.update({
    ...
    #
    # Координаты — на подушках, а не в середине предмета: середина у дивана
    # приходится на спинку, и посаженный туда человек оказывается внутри неё.
    'sofa': [
        {'kind': 'seat', 'x': 0.5, 'y': 0.3, 'use': 'game'},
        {'kind': 'seat', 'x': 1.7, 'y': 0.3, 'use': 'game'},
    ],
    ...
    'armchair': [
        {'kind': 'seat', 'x': 0.15, 'y': 0.25, 'use': 'sit'},
    ],
})
